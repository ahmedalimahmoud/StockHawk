...
public final  class QuoteSyncJob {
    ...
    static void getQuotes(Context context) {
        ...
        try {
            Set<String> stockPref = getStocks(context);
            ...
            while (iterator.hasNext()) {
                ...
                StockQuote quote = stock.getQuote();
                    ...
                    for (HistoricalQuote it : history) {
                        ...
                        historyBuilder.append(new DateFormatSymbols().getMonths()[it.getDate().get(Calendar.MONTH)]);
...
public static  boolean check(String stock)
{
    Boolean x = null;
    try {
        Stock name=YahooFinance.get(stock);
        x = name.getQuote().getPrice() != null;
    } catch (IOException e) {
        e.printStackTrace();
